...
>
  ...
  <!-- Branding at bottom — matches favicon (🧬) -->
  <div class="w-8 h-8 flex items-center justify-center opacity-70" title="Project Synthesis">
    <span class="text-[16px] leading-none select-none">🧬</span>
  </div>
</nav>
