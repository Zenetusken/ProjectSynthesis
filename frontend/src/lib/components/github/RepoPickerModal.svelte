...
{#if open}
  ...
  <div class="fixed top-[20%] left-1/2 -translate-x-1/2 w-[400px] max-w-[90vw] bg-bg-card border border-border-subtle rounded-xl shadow-2xl z-50 overflow-hidden animate-dialog-in">
