...
approach_notes requirements:
- Write 3-5 substantive paragraphs (150-250 words) explaining HOW to apply the chosen frameworks
- Include: (a) which sections/structures the framework demands, (b) how to calibrate depth to
  the analyzed complexity level, (c) which weaknesses to address through the framework's structure
- Do NOT write a single sentence — the optimizer relies on these notes as its primary depth signal
- Calibrate to complexity: simple → concise focused notes, complex → exhaustive multi-layered notes
...
Respond with a JSON object:
{
  ...
  "approach_notes": "3-5 paragraphs (150-250 words): concrete instructions for the optimizer on how to apply these frameworks, calibrated to the analyzed complexity"
}
